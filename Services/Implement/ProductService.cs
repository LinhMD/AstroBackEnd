...
namespace AstroBackEnd.Services.Implement
{
    public class ProductService : IProductService, IDisposable
    {
        ...
        public Product CreateMasterProduct(MasterProductCreateRequest request)
        {
            ...
            {
                throw new ArgumentException("ProductService : " + ex.Message);
            }
        }
        ...
        public Product DeleteProduct(int id)
        {
            ...
            if (product != null)
            {
                _work.Products.Remove(GetProduct(id));
                return product;
            }
            else
            {
        ...
        public IEnumerable<Product> FindProductVariant(FindProductsVariantRequest request)
        {
            ...
            catch (Exception ex) { throw new ArgumentException("ProductService : " + ex.Message); }
        }
        ...
        public Product UpdateMasterProduct(int id, MasterProductsUpdateRequest request)
        {
            ...
            {
                throw new ArgumentException("Can not find product with id(" + id + ")");
            }
        }
        ...
        public Product GetMasterProduct(int id)
        {
            ...
            Product product = _work.Products.FindProducWithAllData(p => p.Id == id && p.MasterProduct == null, p => p.Id).FirstOrDefault();

            if (product == null) throw new ArgumentException("Can not find product ");
